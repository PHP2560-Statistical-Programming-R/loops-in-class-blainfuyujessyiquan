...
author: "Jess Kaminsky, Blain Morin, Lisha Wang, Linde Chen, Fuyu Zou, Yiquan Xu"
...
#return x if it only has one element it it - does not need to be sorted
  if (length(x) < 2) return (x)
# last is the last element to compare with
  for(last in length(x):2) {
    for(first in 1:(last - 1)) {
      #swap the two values if the first value is greater than the value next to it
